...
export function buildMobileModules() {
  return {
    ...
    smartWorkOrders: [
      { id: "swo-1", code: "SWO-001", no: "SWO-001", source: "manual", type: "饲喂工单", title: "A区泌乳牛舍早班饲喂", organizationId: "org-dairy", organizationName: "合力牧业奶牛场", relatedObject: "A区泌乳牛舍 / 泌乳高峰群", priority: "重要", status: "处理中", initiator: "王场长", handler: "刘师傅", createdAt: `${today} 06:50`, deadline: `${today} 09:00`, result: "", requirePhoto: true, requireReview: true, updatedAt: `${today} 08:00`, createdBy: "王场长", updatedBy: "刘师傅", remark: "记录投料、剩料和采食" },
      { id: "swo-2", code: "SWO-002", no: "SWO-002", source: "manual", type: "产奶工单", title: "A区早班产奶录入并送检", organizationId: "org-dairy", organizationName: "合力牧业奶牛场", relatedObject: "A区泌乳牛舍 / 1号奶罐", priority: "紧急", status: "待处理", initiator: "王场长", handler: "刘师傅", createdAt: `${today} 07:20`, deadline: `${today} 10:00`, result: "", requirePhoto: false, requireReview: false, updatedAt: `${today} 07:20`, createdBy: "王场长", updatedBy: "王场长", remark: "异常奶需单独登记" },
      { id: "swo-3", code: "SWO-003", no: "SWO-003", source: "inventory", type: "库存盘点工单", title: "育肥牛饲料低库存复核", organizationId: "org-beef", organizationName: "欧力菲德肉牛场", relatedObject: "育肥牛饲料 / FD-B-20260704", priority: "重要", status: "待处理", initiator: "系统", handler: "管理员", createdAt: `${today} 09:45`, deadline: `${today} 15:00`, result: "", requirePhoto: false, requireReview: true, updatedAt: `${today} 09:45`, createdBy: "系统", updatedBy: "系统", remark: "确认调拨或采购" }
    ],
    milkTasks: [
    ...
    workOrders: [
      { id: "wo-1", code: "WO-001", no: "WO-001", source: "inventory", type: "库存盘点工单", title: "育肥牛饲料低库存处理", content: "肉牛场饲料库低于安全库存，请确认调拨。", status: "待处理", priority: "重要", initiator: "系统", handler: "管理员", businessUnit: "欧力菲德肉牛场", organizationId: "org-beef", organizationName: "欧力菲德肉牛场", relatedBusiness: "库存异常", relatedObject: "育肥牛饲料 / FD-B-20260704", requirePhoto: false, requireReview: true, createdAt: `${today} 09:45`, deadline: `${today} 15:00`, plannedAt: `${today} 15:00`, processLog: "系统由库存预警自动生成", result: "", reviewer: "", updatedAt: `${today} 09:45`, createdBy: "系统", remark: "" },
      { id: "wo-2", code: "WO-002", no: "WO-002", source: "manual", type: "饲喂工单", title: "A区泌乳牛舍早班饲喂", content: "执行泌乳高峰日粮投喂，并记录剩料。", status: "处理中", priority: "重要", initiator: "王场长", handler: "刘师傅", businessUnit: "合力牧业奶牛场", organizationId: "org-dairy", organizationName: "合力牧业奶牛场", relatedBusiness: "饲喂", relatedObject: "A区泌乳牛舍 / 泌乳高峰群", operationRequirement: "投喂后拍照并填写剩料情况。", requirePhoto: true, requireReview: true, createdAt: `${today} 06:50`, deadline: `${today} 09:00`, plannedAt: `${today} 09:00`, processLog: "已开始", result: "", reviewer: "", updatedAt: `${today} 08:00`, createdBy: "王场长", remark: "" },
      { id: "wo-3", code: "WO-003", no: "WO-003", source: "manual", type: "质检工单", title: "原奶批次 HL-MILK-AM 复核", content: "复核早班原奶温度、蛋白、脂肪和药残结果。", status: "待复核", priority: "紧急", initiator: "王场长", handler: "刘师傅", businessUnit: "欧力菲德乳品厂", organizationId: "org-plant", organizationName: "欧力菲德乳品厂", relatedBusiness: "质检样品", relatedObject: "HL-MILK-AM", operationRequirement: "核对留样编号，异常需备注。", requirePhoto: false, requireReview: true, createdAt: `${today} 08:30`, deadline: `${today} 12:00`, plannedAt: `${today} 12:00`, processLog: "刘师傅已提交结果，等待管理员复核", result: "质检结果已录入，药残未检出。", resultSubmittedAt: `${today} 10:40`, resultPhoto: "", resultException: "", reviewer: "王场长", updatedAt: `${today} 10:40`, createdBy: "王场长", remark: "" }
    ],
    messages: [
